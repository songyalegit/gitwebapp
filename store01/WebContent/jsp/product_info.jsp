...
<html>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<div style="margin:20px 0 10px 0;;text-align: center;">
								...
								<a href="javascript:void(0);" >
									<input style="background: url('${pageContext.request.contextPath}/img/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="button" onclick="subm()">
	...
	<script type="text/javascript">
		function subm(){
			...
			var pid=$("#pid").val();
			location.href="${pageContext.request.contextPath}/CartIServlet?method=addCartItem&pid="+pid+"&num="+num;
		}
	</script>
</html>