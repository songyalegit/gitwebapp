			...
			<c:if test="${not empty page.list }">
				<c:forEach items="${page.list }" var="pro">
					<div class="col-md-2" style="height:240px">
						<a href="${pageContext.request.contextPath}/ProductServlet?method=findProductInfo&pid=${pro.pid}">
							<img src="${pageContext.request.contextPath}/${pro.pimage}" width="170" height="170" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findProductInfo&pid=${pro.pid}" style='color:green'>${pro.pname }</a></p>
